        ...
        if (isParamWindow) {
            ...
            const devSetting = new Component("div", {
                ...
                children: [
                    ...
                    new Component("div", { innerText: "Send Custom Event" }),
                    new Component("div", {
                      classList: [ "el", "el-toggler", "svelte-176ijne" ],
                      children: [
                        new Component("div", {
                        ...
                        new Component("input", {
                                type: "text",
                                classList: ["event-data-input"],
                                style: { width: "200px", padding: "10px", borderRadius: "2px", textAlign: "left", backgroundColor: "var(--color-grey)", boxShadow: "0 10px 20px var(--color-shadow) inset", border: "1px solid var(--color-lightgrey)", fontFamily: "var(--font-family-2)", zIndex: "60" },
                                placeholder: "Ex: \"Anon123\"",
                        }),
                      ]
                    }),
                    new Component("div", {
            ...
            wrapper.insertBefore(devSetting.element, wrapper.querySelector("div:nth-child(2)"));
